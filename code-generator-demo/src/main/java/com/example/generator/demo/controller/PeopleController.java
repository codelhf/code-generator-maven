...
import com.example.generator.demo.service.IPeopleService;
...
public class PeopleController {
    ...
    public ServerResponse<Object> list(@RequestParam("pageNum") Integer pageNum,
        ...
        return iPeopleService.list(pageNum, pageSize, params);
    }
    ...
    public ServerResponse<String> insert(@RequestBody PeopleDTO peopleDTO) {
        return iPeopleService.insert(peopleDTO);
    }
    ...
    public ServerResponse<PeopleDTO> select(@PathVariable("id") int id) {
        return iPeopleService.select(id);
    }
    ...
    public ServerResponse<String> update(@PathVariable("id") int id,
        ...
        return iPeopleService.update(id, peopleDTO);
    }
    ...
    public ServerResponse<String> delete(@PathVariable("ids") String ids) {
        return iPeopleService.delete(ids);
    }
