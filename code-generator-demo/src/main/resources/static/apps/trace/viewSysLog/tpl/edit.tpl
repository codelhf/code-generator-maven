<!-- 新增和修改 -->
<div class="" id="edit_v_sys_log_div">
    <form enctype="multipart/form-data" id="edit_v_sys_log_form">
    ...
    <div class="pu-btn bottom-button pd-10 tc">
        <a href="#" class="button-blue ok" id="save_edit_v_sys_log">确认</a>
        <a href="#" class="button-green cancel" id="cancel_edit_v_sys_log">取消</a>
    </div>
</div>
